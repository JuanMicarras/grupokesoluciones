    ...
    <main className="ventas-page">
      ...
      <header className="ventas-hero">
        <div className="hero-content">
          ...
          <p>
            En Grupo KESoluciones ofrecemos suministro e instalación de plantas
            eléctricas diesel para garantizar respaldo energético confiable en
            empresas, edificios, hoteles e industrias en Barranquilla y la
            región Caribe.
          </p>
        </div>
        <div className="heroCard" aria-label="Marca">
          ...
          <p className="heroCardText">
            Continuidad operativa, atención técnica confiable y soluciones a la
            medida.
          </p>
        </div>
      </header>
      ...
      <section className="ventas-content">
        <div className="ventas-info">
          ...
          <ul className="ventas-benefits">
            <li>
              ✅ Plantas eléctricas desde <strong>25 kW hasta 3500 kW</strong>
            </li>
            <li>✅ Equipos abiertos o insonorizados</li>
            <li>
              ✅ Sistemas de operación <strong>Standby o Prime</strong>
            </li>
            <li>
              ✅ Integración con <strong>transferencia automática (ATS)</strong>
            </li>
        ...
        <div className="ventas-brands">
          ...
          <p>
            Nuestras plantas eléctricas están ensambladas con los componentes
            más robustos y reconocidos del mercado, garantizando durabilidad y
      ...
      <section className="ventas-aplicaciones">
        ...
        <p>
          Nuestras soluciones de respaldo energético son utilizadas en
          diferentes sectores que requieren continuidad operativa ante fallas
      ...
      <section className="ventas-cobertura">
        ...
        <p>
          Prestamos servicio de suministro e instalación de plantas eléctricas
          en Barranquilla, Cartagena, Santa Marta, Valledupar y otras ciudades
          de la Costa Caribe, brindando soluciones de generación eléctrica
          confiables para empresas y proyectos comerciales.
        </p>
      </section>
      ...
      <section className="ventas-faq">
        ...
        <div className="faq-item">
          ...
          <p>
            ...
            cabina, el sistema de transferencia automática y las condiciones de
            instalación.
          </p>
        </div>
